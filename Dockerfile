...
LABEL org.opencontainers.image.source="https://github.com/tidynest/raven-nest-mcp" \
      ...
      org.opencontainers.image.description="AI-driven penetration testing - 22 bundled security tools behind 46 safety-hardened MCP endpoints (Metasploit tools require a separate msfrpcd)." \
